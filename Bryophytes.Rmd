...
BetaMap <- ggplot() +
  ...
  geom_sf(data = nw_mount_sf, size = 0.5, alpha=0.1) + theme_gray() +
  theme(legend.text=element_text(size=20), legend.title=element_text(size=0), axis.title = element_blank())
BetaMap

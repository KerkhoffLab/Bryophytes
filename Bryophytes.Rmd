...
BetaLongLat
BetaScatterplot <- ggplot(BetaLongLat, aes(Latitude, Beta, color=pc)) + geom_point(shape = 16, size = 5, show.legend = FALSE, alpha=0.5) + scale_color_gradientn(colours=cols2) + ylab("β diversity") + theme_minimal()
...
AlphaScatterplot <- ggplot(AlphaLongLat, aes(Latitude, Alpha, color=pc)) + geom_point(shape = 16, size = 5, show.legend = FALSE, alpha=0.5) + scale_color_gradientn(colours=cols2) + ylab("α diversity") + xlab(" ") + theme_minimal() 

...
#Load data
```{r}
BryophytePresence <- read.csv("Data/BryophytePresence.csv")
...
BlankRas_tmp <- projectRaster(BlankRas, crs = crs_ref)

BIENpoints <- rasterToPoints(BlankRas_tmp, spatial  = TRUE)
...
BIENpolygons <- rasterToPolygons(BlankRas_tmp, fun = NULL, na.rm = TRUE, n=8, digits = 12)
BIENpolygons
```

...
BetaBoxPlotH <- ggplot(data = FullBeta, aes(reorderedhem, Beta, fill=Type)) + 
  ...
  theme_minimal() + theme(axis.title.y = element_text(size=48), axis.title.x = element_text(size=48),  
                          axis.text.x = element_blank(), axis.text.y = element_text(size=40), legend.text = element_text(size=40), 
...
AlphaBoxPlotH <- ggplot(data = FullAlpha, aes(reorderedhem, Alpha, fill=Type)) + 
  ...
  theme_minimal() + theme(axis.title.y = element_text(size=48), axis.title.x = element_blank(),  
                          axis.text.x = element_blank(), axis.text.y = element_text(size=40), legend.text = element_blank(), 

#MAPPING HORNWORT BETA DIVERSITY
...
# 0.0 Run DataProcessing.R and HornwortDiversity.R to generate necessary data -----------------------------------------------------------------
...
BetaMat <- readRDS("Data/HornwortBetaMat.rds")
CellRichness <- readRDS("Data/HornwortRichness.rds")
...
# 2.0 Map hornwort beta diversity -------------------------------------------------------------------------------------------------------------
...
png("Figures/HornwortBetaMap.png", width = 1000, height = 1000, pointsize = 30)
HornwortBetaMap
dev.off()
